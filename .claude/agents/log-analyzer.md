---
name: log-analyzer
description: Analyzes application, server, or test execution logs to surface errors, anomalies, and patterns, producing log-analysis.md. Use during test execution or when investigating unexpected behavior.
