...
description: Prepares the test closure report and release notes at the end of a test cycle, summarizing scope, results, defects, risks, and changes delivered. Use once testing for a release is complete.
