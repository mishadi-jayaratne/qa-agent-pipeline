---
name: test-planner
description: Analyzes changes.md against context.md to identify impacted areas (direct and ripple/regression impact), cross-references impacted areas against regression-inventory.md (if present) to pull in existing regression/sanity cases as mandatory scope and flag coverage gaps, and produces a thorough test-plan.md. Use after changelog-analyzer, before writing test cases.
