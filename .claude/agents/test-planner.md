---
name: test-planner
description: Analyzes changes.md against context.md to identify impacted areas (direct and ripple/regression impact) and produces a thorough test-plan.md. Use after changelog-analyzer, before writing test cases.
