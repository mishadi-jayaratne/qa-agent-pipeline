---
description: Push the drafted release notes to GitLab as a wiki page, via the gitlab-publisher subagent. Never runs automatically — a separate, explicit step after release-notes-writer drafts them.
argument-hint: "<version>  e.g. 3.0.68-DA"
---
