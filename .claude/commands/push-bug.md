---
description: Push one already-drafted bug report to GitLab as an issue, via the gitlab-publisher subagent. Never runs automatically — a separate, explicit step after bug-reporter drafts the report.
argument-hint: "<bug-slug>  e.g. login-timeout"
---
